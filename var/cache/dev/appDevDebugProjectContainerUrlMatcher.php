...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/color/admin')) {
            // color_index
            if (rtrim($pathinfo, '/') === '/color/admin') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\ColorController::indexAction',  '_route' => 'color_index',);
            }
            not_color_index:

            // color_new
            if ($pathinfo === '/color/admin/new') {
            ...
            // color_show
            if (preg_match('#^/color/admin/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_color_show;
                }
            ...
            // color_edit
            if (preg_match('#^/color/admin/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_color_edit;
                }
        ...
        if (0 === strpos($pathinfo, '/modelo')) {
            ...
            if (rtrim($pathinfo, '/') === '/modelo') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_modelo_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'modelo_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\ModeloController::indexActionUser',  '_route' => 'modelo_index',);
            }
            not_modelo_index:

            // modelo_show
            if (preg_match('#^/modelo/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_modelo_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'modelo_show')), array (  '_controller' => 'AppBundle\\Controller\\ModeloController::showAction',));
            }
            not_modelo_show:

            if (0 === strpos($pathinfo, '/modelo/admin')) {
                // modelo_new
                if ($pathinfo === '/modelo/admin/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_modelo_new;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\ModeloController::newAction',  '_route' => 'modelo_new',);
                }
                not_modelo_new:

                // modelo_edit
                if (preg_match('#^/modelo/admin/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_modelo_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'modelo_edit')), array (  '_controller' => 'AppBundle\\Controller\\ModeloController::editAction',));
                }
                not_modelo_edit:

                // modelo_delete
                if (preg_match('#^/modelo/admin/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_modelo_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'modelo_delete')), array (  '_controller' => 'AppBundle\\Controller\\ModeloController::deleteAction',));
                }
                not_modelo_delete:
        ...
        if (0 === strpos($pathinfo, '/p')) {
            if (0 === strpos($pathinfo, '/pedido')) {
                // pedido_index
                if (rtrim($pathinfo, '/') === '/pedido/admin') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/pedido/admin')) {
                    // pedido_show
                    if (preg_match('#^/pedido/admin/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    // pedido_edit
                    if (0 === strpos($pathinfo, '/pedido/admin/edit') && preg_match('#^/pedido/admin/edit/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
            ...
            // app_prueba_index
            if ($pathinfo === '/prueba') {
                return array (  '_controller' => 'AppBundle\\Controller\\PruebaController::indexAction',  '_route' => 'app_prueba_index',);
            }
